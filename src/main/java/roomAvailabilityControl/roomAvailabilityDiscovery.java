...
public class roomAvailabilityDiscovery {
	...
	public static ServiceInfo run(String service_serverStreaming) {
		...
		try {
			...
			jmdns.addServiceListener(service_serverStreaming, msl);
