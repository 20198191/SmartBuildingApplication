...
public class roomAvailabilityRegistration {

	public void run(int port, String service_serverStreaming, String service_name) {
		...
		try {
			...
			ServiceInfo serviceInfo = ServiceInfo.create(service_serverStreaming, service_name, service_port, service_desc);
			...
			System.out.printf("registering service with type: %s and name: %s on port %d ", service_serverStreaming, service_name, service_port);
