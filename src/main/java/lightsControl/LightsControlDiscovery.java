...
public class LightsControlDiscovery {
	...
	public static ServiceInfo run(String service_bidirectionalStreaming) {
		...
		try {
			...
			jmdns.addServiceListener(service_bidirectionalStreaming, msl);
